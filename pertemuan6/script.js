...
console.log(inputWaktuPersiapan);
console.log(waktuPratinjau);

inputWaktuPersiapan.addEventListener("input", function(){
    console.log("Pengguna mengetik waktu persiapan");
});

inputWaktuPersiapan.addEventListener("input", function(){
    const teksInputan = inputWaktuPersiapan.value;
    waktuPratinjau.textContent = teksInputan + " menit";
});
...
console.log(inputKesulitan);
console.log(kesulitanMeter);
console.log(kesulitanText);
